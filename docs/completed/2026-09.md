...
- [ ] **B54 stays open with 48.** Placing them is no longer blocked on an instrument — but the
      placement itself, the near-misses' verdicts, and the second-subject family's decision are
      still to do, and the last of those is the owner's.
