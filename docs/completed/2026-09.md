...
- [ ] **B54 stays open.** The 51 now carry their page and their size, so placing them is no longer
      blocked on an instrument — but the placement itself, the near-misses' verdicts, and the
      second-subject family's decision are still to do, and the last of those is the owner's.
