...
- Create: `docs/superpowers/reports/2026-09-05-wiki-dataset-report.md` (execution report: tasks, commits, gates, what the review found, meta diagnostics with the most frequent unknown templates as a list of the next ones to cover)
