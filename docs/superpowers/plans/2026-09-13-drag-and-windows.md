...
**Files:**
- Create: `docs/superpowers/plans/2026-09-13-drag-and-windows-report.md`
...
```bash
git add docs/superpowers/plans/2026-09-13-drag-and-windows-report.md
...
- Modify: `docs/superpowers/plans/2026-09-13-drag-and-windows-report.md`
...
//! `docs/superpowers/plans/2026-09-13-drag-and-windows.md`: without this the drag would hang
...
```bash
git add ui/src/lib/window/pointerSource.ts docs/superpowers/plans/2026-09-13-drag-and-windows-report.md
