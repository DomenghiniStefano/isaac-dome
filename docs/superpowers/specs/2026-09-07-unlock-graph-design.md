...
> about where the spec stands. The plan is archived as `docs/superpowers/plans/archive/2026-09-07-unlock-graph.md`
> — which this project only does when a sub-project merges into `develop` — and the report is
> `docs/superpowers/reports/2026-09-07-unlock-graph-report.md`. Read the report first: where the two disagree, it is
