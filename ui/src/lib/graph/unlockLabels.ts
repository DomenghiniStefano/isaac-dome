...
import { unlockKindLabel } from './unlockKindText'
...
const facetTitle: Record<FacetId, Message> = {
...
// Partial wears the dashed blocked square, like its badge.
const stateDot = stateDots<NodeState>({
  [NodeState.Done]: StateTone.Done,
  [NodeState.Now]: StateTone.Now,
  [NodeState.Blocked]: StateTone.Blocked,
  [NodeState.Partial]: StateTone.Partial,
})
