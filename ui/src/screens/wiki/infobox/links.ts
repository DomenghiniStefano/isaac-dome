...
// What every row of a page's card needs to draw a reference and follow it: whether it opens,
// and the way back up to the page. Provided once by `WikiInfobox`, so the body of each
